...
\resumeProjectHeading
{\textbf{Sampling uniformly from $0-1$ tensors} $|$ \textit{upcoming} $|$ Prof Guanyang Wang}{Jan '24 -- ~~~~~~~}
\resumeItemListStart
\resumeItem {\emph{\color{grey}
The project is about developing efficient algorithms to uniformly sample from the space of $0-1$ tensors with given marginal sums.
}}
\resumeItemListEnd 

\resumeProjectHeading
{\textbf{Wasserstein distance to various statistical models} $|$ \textit{current}}{Jun -- Dec '23}
\resumeItemListStart
\resumeItem {\emph{\color{grey}
The project is about developing efficient algorithms to uniformly sample from the space of $0-1$ tensors with given marginal sums.
}}
...
%-----------INTERNSHIPS-----------
\section{Relevant Reading Projects}
\resumeSubHeadingListStart
...
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Algebra I (Linear algebra)}} \hspace{20mm} BSc 1st year - head tutor \hspace{13.3mm}  {\textbf{Prof T R Ramadas}}}}{\hfill Sep -- Dec '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Functional Programming in Haskell}}\hspace{5.5mm}  BSc and MSc Comp. Sci. 1st year \hspace{1mm}  {\textbf{Prof S P Suresh}}}}{\hfill Sep -- Dec '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Probability Theory}} \hspace{32.3mm}  BSc 1st year \hspace{32mm}  {\textbf{Prof P Sankaran}}}}{\hfill Apr -- Jul '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Discrete Mathematics}} \hspace{27.4mm} BSc 1st year \hspace{31.8mm}  {\textbf{Prof K V Subrahmanyam}}}}{\hfill Apr -- Jul '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Design and Analysis of Algorithms}} \hspace{6.7mm}  MSc Data Science 1st year \hspace{11.3mm} {\textbf{Prof G Philip}}}}{\hfill Apr -- Jul '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Algebra I (Linear algebra)}} \hspace{20mm} BSc 1st year \hspace{32mm}  {\textbf{Prof T R Ramadas}}}}{\hfill Dec '20 -- Mar '21}
\resumeItem {\hspace{0.2in}\emph{\color{grey}
\emph{\textbf{Functional Programming in Haskell}}\hspace{5.5mm}  BSc and MSc Comp. Sci. 1st year \hspace{1mm}  {\textbf{Prof S P Suresh}}}}{\hfill Dec '20 -- Mar '21}
\resumeItemListEnd }
\vspace{-10pt}
...
%\resumeProjectHeading
%{\color{grey}\textbf{GCT III: deciding positivity of LR coefficients} $|$ \emph{$1$ talk} $|$ Rutgers \textit{CS Theory Reading Seminar}}
%{\color{grey}Sep '23}
%{}
%\vspace{-20pt}
...
{Jan '18}
{\resumeItemListStart
\resumeItem {\emph{\color{grey}Selected for \textbf{Indian National Mathematical Olympiad} (INMO) \textbf{Training Camp} | top 30 school students in West Bengal.}}
\resumeItemListEnd}
